      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            Welcome to Algorithmic Odyssey! To complete your sign-up, please
            verify your email by entering the code below on the verification
            page:
          </Text>
        ...
        <Section style={btnContainer}>
          ...
          <Hr style={hr} />
          <Text style={footer}>DHVSU Bacolor Main Campus</Text>
        </Container>
      </Body>
    </Html>
  );
